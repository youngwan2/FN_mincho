    ...
    return (
        <Portal >
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[1100] flex items-center justify-center p-4 overflow-y-auto">
                <div
                    className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto animate-fade-down animate-duration-300"
                            ...
                            <div className="rounded-xl py-6 px-7 mt-4 text-gray-800 shadow-sm border border-gray-100">
                                ...
                                <ul className="space-y-3">
                                    <li className="text-gray-700 flex items-start gap-2" >
                                        ...
                                        <p className=''>추천된 약초 정보는 <a className="text-[#05D182] border-b border-[#05D182] hover:text-[#03A77F]" href="https://www.nongsaro.go.kr/portal/ps/psz/psza/contentMain.ps?menuId=PS04103&pageUnit=8" target="_blank">농사로</a> 민간약초 컨텐츠에 근거합니다.</p>
                                    </li>
                                    <li className="text-gray-700 flex items-start gap-2" >
                                        <div className="bg-[#a3a7a5]/10 rounded-full h-6 w-6 flex items-center justify-center mt-0.5">
                                            <span className="text-primary-green font-bold">2</span>
